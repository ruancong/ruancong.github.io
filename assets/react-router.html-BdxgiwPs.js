...
<span class="line">&lt;/li&gt;</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="form-替代-form" tabindex="-1"><a class="header-anchor" href="#form-替代-form"><span>Form 替代 form</span></a></h3><p><code>Form</code> prevents the browser from sending the request to the server and sends it to your route <code>action</code> instead. In web semantics, a POST usually means some data is changing. By convention, React Router uses this as a hint to automatically revalidate the data on the page after the action finishes. That means all of your <code>useLoaderData</code> hooks update and the UI <strong>stays in sync with your data automatically</strong>! Pretty cool.</p>`,14)]))}const c=n(l,[["render",t],["__file","react-router.html.vue"]]),o=JSON.parse('{"path":"/Frontend/react/react-router.html","title":"","lang":"zh-CN","frontmatter":{},"headers":[{"level":3,"title":"相对路径","slug":"相对路径","link":"#相对路径","children":[]},{"level":3,"title":"添加错误页面","slug":"添加错误页面","link":"#添加错误页面","children":[]},{"level":3,"title":"Client Side Routing","slug":"client-side-routing","link":"#client-side-routing","children":[]},{"level":3,"title":"Form 替代 form","slug":"form-替代-form","link":"#form-替代-form","children":[]}],"git":{"updatedTime":1728526917000,"contributors":[{"name":"RuanCong","email":"1308811723@qq.com","commits":1}]},"filePathRelative":"Frontend/react/react-router.md"}');export{c as comp,o as data};
